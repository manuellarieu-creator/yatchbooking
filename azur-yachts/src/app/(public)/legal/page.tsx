            ...
            <div className="tab-content active">
              ...
              <div className="doc-section" id="cgu-6">
                ...
                <div className="prose">
                  ...
                  <p>Toute demande d'annulation doit être adressée par écrit à l'équipe VoyYacht via le formulaire de contact ou par email à <Link href="mailto:info@voyyacht.com">info@voyyacht.com</Link> ou en cliquant sur le bouton d'annulation depuis l'espace client. Les remboursements sont traités dans un délai de 3 à 10 jours ouvrés selon le mode de paiement utilisé.</p>
                  <div className="info-box navy">
