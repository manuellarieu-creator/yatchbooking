...
const FAQ_DATA = [
  // ── LOCATION ──
  { id: 'l1', cat: 'location', q: "Comment fonctionne la location de yacht sur VoyYacht ?", a: "VoyYacht est une plateforme de mise en relation entre propriétaires de yachts vérifiés et clients. Vous choisissez votre yacht, sélectionnez vos dates, soumettez une demande de réservation, effectuez le paiement, et notre équipe valide l'ensemble. Chaque annonceur est vérifié individuellement par notre équipe avant de pouvoir publier une annonce." },
  ...
  // ── PAIEMENT ──
  { id: 'p1', cat: 'paiement', q: "Quels modes de paiement sont acceptés ?", a: "VoyYacht accepte trois modes de paiement, configurés par notre équipe : carte bancaire via Stripe (Visa, Mastercard, Amex), PayPal, ou virement bancaire SEPA / instantané. Le mode disponible est affiché sur la page de paiement au moment de votre réservation." },
