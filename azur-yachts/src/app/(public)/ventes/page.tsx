...
import '../listings/listings.css'; // Reusing listings CSS
...
function VentesContent() {
  ...
  useEffect(() => {
    async function fetchListings() {
      try {
        const res = await fetch('/api/listings?limit=50&forSale=true');
  ...
  const filteredYachts = useMemo(() => {
    return yachts.filter(y => {
      ...
      if (sortOrder === 'price-desc') return (b.salePrice || 0) - (a.salePrice || 0);
      ...
      <div className="page-hero">
        ...
        <div className="page-hero-inner">
          <div className="breadcrumb">
            ...
            <span className="current">Bateaux en Vente</span>
          </div>
          <span className="page-eyebrow">Achetez votre yacht</span>
          <h1 className="page-title">Découvrez nos yachts<br/><em>à la vente</em></h1>
          <p className="page-intro">
            Découvrez notre sélection exclusive de bateaux disponibles à l'achat. Devenez propriétaire d'un navire d'exception, vérifié par nos soins.
          </p>
        </div>
      </div>
      ...
      <div className="page-body">
        ...
        <aside className={`filters-sidebar ${mobileFilterOpen ? 'mobile-open' : ''}`}>
          ...
          <div className="filter-group">
            <div className="filter-group-title">Prix de vente</div>
            <div className="range-wrap">
              <div className="range-values">
                <span className="range-val">€{priceMin.toLocaleString('fr-FR')} <small>min</small></span>
                <span className="range-val">€{priceMax.toLocaleString('fr-FR')} <small>max</small></span>
              </div>
        ...
        <main className="listing-main">
          <div className="listing-toolbar">
            <div className="toolbar-left">
              <span className="count-label"><em>{filteredYachts.length}</em> bateaux à vendre</span>
          ...
          {filteredYachts.length === 0 ? (
            <div className="empty-state">
              ...
              <div className="empty-title">Aucun yacht à vendre trouvé</div>
                  ...
                  <Link href={`/yacht/${yacht.id}`} key={yacht.id} className="yacht-card" style={{ animationDelay: `${i * 0.06}s` }}>
                    <div className="card-img">
                      ...
                      {yacht.isAtSea ? (
                        ...
                        <span className="card-badge" style={{ background: 'var(--gold)', fontWeight: 'bold' }}>À VENDRE</span>
                      )}
